...
df0 = pd.read_csv("covid_pred/CONVENIENT_global_confirmed_cases.csv")
df1 = pd.read_csv("covid_pred/CONVENIENT_global_deaths.csv")
...
world.head()
continent=pd.read_csv("covid_pred/continents2.csv")
